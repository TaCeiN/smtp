...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(431, 406)
        Form.setMinimumSize(QSize(431, 406))
        Form.setMaximumSize(QSize(431, 406))
        self.gridLayoutWidget = QWidget(Form)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 412, 352))
        ...
        self.mail_password_visible = QPushButton(self.gridLayoutWidget)
