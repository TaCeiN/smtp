...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(387, 303)
        MainWindow.setMinimumSize(QSize(387, 303))
        MainWindow.setMaximumSize(QSize(387, 303))
        icon = QIcon()
        ...
        self.horizontalLayoutWidget_3.setGeometry(QRect(20, 80, 321, 21))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QRect(10, 100, 351, 61))
        ...
        self.email_button.setGeometry(QRect(20, 210, 111, 24))
        self.sending_confirm = QLabel(self.centralwidget)
        self.sending_confirm.setObjectName(u"sending_confirm")
        self.sending_confirm.setGeometry(QRect(120, 240, 110, 19))
        self.settings_button = QPushButton(self.centralwidget)
        self.settings_button.setObjectName(u"settings_button")
        self.settings_button.setGeometry(QRect(260, 20, 111, 24))
        self.progressBar = QProgressBar(self.centralwidget)
        self.progressBar.setObjectName(u"progressBar")
        self.progressBar.setGeometry(QRect(120, 40, 118, 23))
        self.progressBar.setValue(0)
        self.DB_file_2 = QLabel(self.centralwidget)
        self.DB_file_2.setObjectName(u"DB_file_2")
        self.DB_file_2.setGeometry(QRect(130, 10, 110, 19))
        self.email_button_stop = QPushButton(self.centralwidget)
        self.email_button_stop.setObjectName(u"email_button_stop")
        self.email_button_stop.setGeometry(QRect(230, 210, 111, 24))
